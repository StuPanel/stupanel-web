...
export default function ChatPage() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex gap-0 rounded-2xl overflow-hidden border border-slate-200 bg-white shadow-sm">
                ...
                groupedMessages.map(({ date, msgs }) => (
                  <div key={date} className="space-y-2">
                    ...
                    {msgs.map(msg => {
                      ...
                      return (
                        <div key={msg.id} className={cn("flex items-end gap-2 group", isMe ? "flex-row-reverse" : "flex-row")}>
                          {/* Avatar */}
